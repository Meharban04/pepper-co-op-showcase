...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Co-op Portfolio — Pepper Labs Co-op" },
      { name: "description", content: "Four months building internal tools and AI automations at Pepper Labs (Jan–Apr)." },
      { property: "og:title", content: "Co-op Portfolio — Pepper Labs Co-op" },
      ...
      { name: "twitter:title", content: "Co-op Portfolio — Pepper Labs Co-op" },
